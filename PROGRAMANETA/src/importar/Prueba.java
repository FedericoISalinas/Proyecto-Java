...
public class Prueba {
    public static void menu() throws IOException, InterruptedException {
        ...
        // Creamos un plan de eleccion al tipo de suscripcion mesl,mensual,anual - We create a plan of choice to the type of weekly, monthly, annual subscription
        ...
        System.out.println("");
        // En el caso que se eilja la opcion 1 se hara lo siguiente - In the event that option 1 is chosen, the following will be done
        switch (opcion) {
            case 1:
                ...
                opcion = Integer.parseInt(entrada.nextLine());
                // el usuario elige el método de pago deseado - the user chooses the desired payment method
                // Dentro de la opcion 1 creamos otro "SEGUN" con diferentes opciones - Within option 1 we create another "SEGUN" with different options
                switch (opcion) {
                    case 1:
                        ...
                        opcion = Integer.parseInt(entrada.nextLine());
                        // En el caso que elija la opcion 1 se le pedira que vuelva a elegir una opcion - In case you choose option 1 you will be asked to choose an option again
                        switch (opcion) {
                            case 1:
                                ...
                                switch (opcion) {
                                    case 1:
                                        ...
                                        System.out.println("");
                                        System.out.println("Presenta este cupón en cualquier sucursal Pagofácil para realizar el pago.");
                                        System.out.println("Su pago será procesado como máximo 1 dáa hábil después del pago.");
                                        System.out.println("Fecha de expiración: 30/04/2022");
                                        System.out.println("");
                                        System.out.println("Número de pedido                                 84929102");
                                        System.out.println("");
                                        System.out.println("Valor:                                           ARS $" + (totalmes));
                                        System.out.println("");
                                        System.out.println("Código manual                                    2123864912859931272");
                                        System.out.println("");
                                        System.out.println("                          IMPRIMIR TICKET");
                                        System.out.println("=====================================================================   ");
                                        System.out.println("              Bienvenido al club la programaneta                        ");
                                        System.out.println("");
                                        System.out.println("");
                                        // en caso de elegir opcion2 = completa los datos requeridos - in case of choosing option 2 = complete the required data 
                                        break;
                            ...
                            case 4:
                                ...
                                System.out.println("Sus datos han sido cargados correctamente");
                                System.out.println("Presione cualquier tecla para ver la factura");
                                System.in.read(); // a diferencia del pseudocdigo, espera un Enter, no cualquier tecla
                                System.out.println("Cargando");
                                Thread.sleep(1000);
                                System.out.println(""); // no hay forma directa de borrar la consola en Java
                                System.out.println("DATOS DE LA COMPRA");
                                ...
                                System.out.println("                            Instrucciones de pago");
                                System.out.println("");
                                System.out.println("Presenta este cupón en cualquier sucursal Rapipago para realizar el pago.");
                    ...
                    case 5:
                        ...
                        Thread.sleep(1000);
                        System.out.println(""); // no hay forma directa de borrar la consola en Java
                        System.out.println("MERCADO PAGO                                     COMPROBANTE DE PAGO");
                        System.out.println("                                                 2123864912859931272");
                        System.out.println("");
                        ...
                        System.out.println("Valor de la factura                                   " + (totalmes));
                        System.out.println("");
                        System.out.println("Total pagado                                          " + (totalmes));
                        System.out.println("");
                        System.out.println("");
            ...
            case 2:{
                ...
                System.in.read(); // a diferencia del pseudocdigo, espera un Enter, no cualquier tecla
                System.out.println(""); // no hay forma directa de borrar la consola en Java
                System.out.println("Su compra al servicio Programaneta por un monto de $" + (Crédito) + " fue realizada con éxito");
                ...
                System.out.println("=====================================================================");
                System.out.println("");
                // en caso de elegir opcion Débito= completa los datos requeridos = in case of choosing debit option = complete the required data
                break;
                }
            case 3:
                System.out.println("Escriba el nombre del titular de la tarjeta");
                ...
                System.in.read(); // a diferencia del pseudocdigo, espera un Enter, no cualquier tecla
                System.out.println(""); // no hay forma directa de borrar la consola en Java
                System.out.println("Su compra al servicio Programaneta por un monto de $" + (Débito) + " fue realizada con éxito");
                System.out.println("Muchas gracias por usar nuestro servicio.");
                System.out.println("");
                System.out.println("=====================================================================   ");
                System.out.println("              Bienvenido al club la programaneta                        ");
